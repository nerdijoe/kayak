...
#mongoimport --host cluster0-shard-00-00-i5u9w.mongodb.net:27017,cluster0-shard-00-01-i5u9w.mongodb.net:27017,cluster0-shard-00-02-i5u9w.mongodb.net:27017 --ssl -u nerdijoe -p '7jk6*g6AEL' --authenticationDatabase admin  --db kayak_dev --collection flights --drop --file data/MOCK_DATA_new_flights.json --jsonArray
##
#mongoimport --host cluster0-shard-00-00-i5u9w.mongodb.net:27017,cluster0-shard-00-01-i5u9w.mongodb.net:27017,cluster0-shard-00-02-i5u9w.mongodb.net:27017 --ssl -u nerdijoe -p '7jk6*g6AEL' --authenticationDatabase admin  --db kayak_dev --collection hotels --drop --file data/MOCK_DATA_new_hotels.json --jsonArray
