...
const appRoutes = [
    { path: "/dashboardkayak", name: "Car Stats", icon: "pe-7s-graph", component: DashboardCar },
    ...
    { path: "/hotelBilling", name: "Hotel Billings", icon: "pe-7s-door-lock", component: HotelBillingList },
    { path: "/flightBilling", name: "Flight Billings", icon: "pe-7s-plane", component: FlightBillingList },
